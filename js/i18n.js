...
window.T = {
  uk: {
    ...
    srv2_a:'Заклади й бари', srv2_b:'Офіси та шоуруми', srv2_c:'Спортзали',
    srv3_t:'Брендові<br>активації',
    srv3_a:'Розпис на подіях', srv3_b:'Вітрини', srv3_c:'Мерч і упаковка',
    srv4_t:'Зйомка<br>процесу',
    srv4_a:'Відео від першої особи', srv4_b:'Реклама й соцмережі', srv4_c:'Монтаж',
    order_cta:'Так, розкажу про проєкт',
  ...
  en: {
    ...
    srv2_a:'Venues and bars', srv2_b:'Offices and showrooms', srv2_c:'Gyms',
    srv3_t:'Brand<br>activations',
    srv3_a:'Live painting at events', srv3_b:'Shop windows', srv3_c:'Merch and packaging',
    srv4_t:'Filming<br>the process',
    srv4_a:'First-person video', srv4_b:'Ads and social media', srv4_c:'Editing',
    order_cta:'Yes, let me tell you about it',
...
/* Роботи. Порядок тут = порядок на сайті.
   size:'wide' — широка плитка (пів рядка), '' — звичайна (третина).
...
window.WORKS = [
  ...
  {f:'02-wall-green.jpg',     size:'wide', uk:'Зелений шматок у цеху',     en:'Green piece in a factory',   tag:'2024'},
  {f:'05-train-yellow.jpg',   size:'',     uk:'Вагон, жовте з червоним',   en:'Carriage, yellow on red',    tag:'28,1 млн переглядів', tagEn:'28.1m views'},
  {f:'06-door-green.jpg',     size:'',     uk:'Зелене по білих дверях',    en:'Green on white doors',       tag:'26,3 млн переглядів', tagEn:'26.3m views'},
  {f:'07-train-blue.jpg',     size:'',     uk:'Біла лінія по синьому',     en:'White line on blue',         tag:'16,1 млн переглядів', tagEn:'16.1m views'},
  {f:'03-wall-blue.jpg',      size:'wide', uk:'Синій wildstyle',           en:'Blue wildstyle',             tag:'2024'},
  {f:'04-wall-olive.jpg',     size:'wide', uk:'Оливковий шматок',          en:'Olive piece',                tag:'2024'},
  {f:'08-train-turquoise.jpg',size:'',     uk:'Бірюзовий вагон',           en:'Turquoise carriage',         tag:'14,2 млн переглядів', tagEn:'14.2m views'},
  {f:'09-concrete-yellow.jpg',size:'',     uk:'Жовте з червоним',          en:'Yellow and red',             tag:'11,5 млн переглядів', tagEn:'11.5m views'},
  {f:'10-concrete-orange.jpg',size:'',     uk:'Помаранчеве по бетону',     en:'Orange on concrete',         tag:'10,9 млн переглядів', tagEn:'10.9m views'},
